		 ...
		 <div class="col-sm-12 col-md-8">
			 <div class="card mb-4">
				 <div class="card-body">
					 ...
					 {
						 	buildCafeMenu(array('Item', 'Price', 'Type', 'In Cart'), $conn, $queryLazenbysList, $_SESSION["loggedIn"], true);
					 }
					 else
					 {
						 buildCafeMenu(array('Item', 'Price', 'Type'), $conn, $queryLazenbysList, $_SESSION["loggedIn"], true);
					 }
					 ?>
				 </div>
			 </div>
